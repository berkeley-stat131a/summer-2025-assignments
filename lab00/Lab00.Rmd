...
Edit where it says "YOUR NAME HERE" to... your actual name.
...
-   FIRST TIME ONLY - go to bCourses and click "Gradescope" on the left sidebar. This will get you set up and logged in. From then on, you can just click the link on the course home page (below).
...
## **You're done with Lab 00! Don't forget the other assignment due tonight, the pre-course survey (see website)**
