...
*Note: this is a 1% sample of the okcupid data, after I've cleaned it up. This makes the statistical tests more interesting, as the original dataset is so big that pretty much everything is significant, even if small (remember our conversation on "power"?).*
